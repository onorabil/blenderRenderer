...
def render_scene(camera, baseDir, numViews, outputs, BBox, model_identifier):
...
if __name__ == "__main__":
    ...
    for item in bpy.data.objects:
        ...
        item.data.materials.append(poliigon_material)
...
#blender -b --python main.py -- models/alder_leaf/model_normalized.obj --material materials/GroundMoss001_3K --views_x=4 --views_y=4 --views_z=4 --output_folder output
